...
//           />
//           <div
//             className={`absolute inset-0 bg-opacity-50 bg-[#75B4C2] flex justify-end transition-opacity duration-500 ${
    ...
    <div className="container1 font-avenir justify-between overflow-hidden">
      ...
      >
        <div className="relative h-[400px] w-full font-avenir">
          ...
          <div
            className={`absolute inset-0 bg-opacity-50 bg-[#75B4C2] flex justify-end ${
              maxWidth ? "p-10" : "p-1"
            } flex-col transition-opacity duration-500 ${
              maxWidth ? "opacity-100" : "opacity-0"
            }`}
          >
            <div
              className={`${maxWidth ? "flex justify-end flex-col" : "hidden"}`}
            >
              <h2 className="text-[24px] leading-[32px] font-[800] text-start">
                Electrical
              </h2>
      ...
      >
        <div className="relative h-[400px] w-full font-avenir">
          ...
          />
          <div
            className={`absolute inset-0 bg-opacity-50 bg-[#5389B9] max-h-[400px] flex items-end justify-center transition-opacity duration-500 ${
      ...
      >
        <div className="relative h-[400px] w-full font-avenir">
          ...
          />
          <div
            className={`absolute inset-0 bg-opacity-50 bg-[#E78F6D] max-h-[400px] flex items-end justify-center transition-opacity duration-500 ${
