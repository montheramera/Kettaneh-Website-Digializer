      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-[32px]">
          <div>
            ...
            <div className="mt-[12px] mb-[8px] font-[800] text-[18px] leading-[28px]">Landmark Projects</div>
          ...
          <div>
            ...
            <div className="mt-[12px] mb-[8px] font-[800] text-[18px] leading-[28px]">Global Partners</div>
            <div className="font-[500] text-[16px] leading-[24px]">
          ...
          <div>
            <div  className="font-[800] text-[60px] leading-[60px]">+100</div>
            <div className="mt-[12px] mb-[8px] font-[800] text-[18px] leading-[28px]">Years of experience</div>
            <div className="font-[500] text-[16px] leading-[24px]">
          ...
          <div>
            ...
            <div className="mt-[12px] mb-[8px] font-[800] text-[18px] leading-[28px]">Rating</div>
            <div className="font-[500] text-[16px] leading-[24px]">
