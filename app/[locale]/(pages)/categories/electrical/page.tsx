...
export async function generateMetadata({ params }: Props) {
  try {
    ...
    const title = seo.meta_title || "electrical";
    const description = seo.meta_description || "electrical";
    ...
    return {
      ...
      description,
      alternates: {
        canonical: `${process.env.NEXT_PUBLIC_MAIN_SITE}/en/categories/electrical`,
      },
    };
  } catch (error) {
