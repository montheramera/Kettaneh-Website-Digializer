...
export async function generateMetadata({ params }: Props) {
  try {
    const res = await fetch(`${API_URL}/api/categories?filters[title]=Machinery&populate[seo][populate]=*`, {
      cache: "no-store",
    })
    ...
    const title = seo.meta_title || "machinery";
    const description = seo.meta_description || "machinery";
    ...
    return {
      ...
      description,
      alternates: {
        canonical: `${process.env.NEXT_PUBLIC_MAIN_SITE}/en/categories/machinery`,
      },
    };
  } catch (error) {
