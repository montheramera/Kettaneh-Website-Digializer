        ...
        <div className="grid md:grid-cols-2 mt-[64px]  text-[18px] font-[400] leading-[28px] text-paragraph">
          <div className="flex">
            ...
            <p className="lg:max-w-[536px]">
              Ever since the company &apos;s establishment in 1922, the Kettaneh
              Group has sought to provide true satisfaction to its customers and
              potential clients.
              <br />
              <br />
              Francis the eldest of the four Kettaneh brothers first established
              the company alone but was later joined by his brother Alfred, and
              afterwards by Charles and Desire. Four determined men working
              hand, hand in hand, to start out what later expanded into the
              Kettaneh Freres ventures.
              <br />
              <br />
              ...
              employees are the foundation on which the Group’s entire operation
              is based. Today, the Francis and Charles Kettaneh families own the
              Group and as always Kettaneh since 1922 is, committed to serving
              you.
            </p>
          </div>
          <div className="flex">
        ...
        <div className="grid md:grid-cols-2 mt-[64px]  text-[18px] font-[400] leading-[28px] text-paragraph">
          ...
          <div className="flex">
            ...
            <p className="text-[20px] font-[500] leading-[28px] text-paragraph">
              ...
              expectations of its customers and strengthened its ties with its
              employees, suppliers and communities. A leading company in the
              Jordanian market, which started its operation in 1948 and since
              then has represented a number of premium brands such as Siemens,
              Atlas Copco, Haier, and Linde to name a few. With three
              specialized Departments, Kettaneh is able to provide and satisfy
              all market needs for industrial equipment.
            </p>
          </div>
        </div>
      </section>
