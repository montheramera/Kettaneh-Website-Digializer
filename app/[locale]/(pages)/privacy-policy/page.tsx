...
const fetchPrivacyData = async () => {
  ...
  const privacy = data.data.map((el: any)=> el.attributes).filter((el: any)=> el.title === "Privacy Policy");
  return privacy;
};
          ...
          <section className="max-w-[1440px] m-auto">
            <div>
              ...
              <Suspense fallback={"loading"}>
                <DynamicParagraph content={privacyData[0]?.text} classes="text-[18px] lg:text-[20.1px] font-[400] leading-[28px] text-paragraph lg:my-4 lg:max-w-[1216px]" />
              </Suspense>
